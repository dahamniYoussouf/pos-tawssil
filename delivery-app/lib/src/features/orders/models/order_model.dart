...
class OrderModel {
  ...
  factory OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    return OrderModel(
      ...
      deliveryPerson: deliveryPerson,
      estimatedDeliveryTime: parseDate(json['estimated_delivery_time'] ?? json['estimated_delivery_time'] ?? json['delivery_time']),
      ...
      deliveryDistance: parseNullableDouble(json['distance_km'] ?? json['distance'] ?? json['distance_m']),
      deliveryTimeMinutes: parseInt(json['deliveryTimeMinutes'] ?? json['delivery_time_minutes']),
      deliveryPrice: parseNullableDouble(json['deliveryPrice'] ?? json['delivery_price'] ?? json['delivery_fee']),
      client: client,
    );
  }
