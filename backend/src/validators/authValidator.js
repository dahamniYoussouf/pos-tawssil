...
import { normalizeAndValidatePhone, normalizePhoneNumber } from '../utils/phoneNormalizer.js';
...
export const requestOTPValidator = [
  body('phone_number')
    ...
    .custom((value) => Boolean(normalizeAndValidatePhone(value)))
    .withMessage('Invalid phone number format. Expected 213 followed by exactly 9 digits')
];

export const requestRegistrationEmailCodeValidator = [
  body('email')
    .trim()
    .notEmpty()
...
export const verifyOTPValidator = [
  ...
  body('device_platform')
    ...
    .withMessage('Device platform must be android, ios, or web')
];
