...
import '../../auth/services/user_service.dart' as user_service;
  ...
  Future<void> requestLocationPermission() async {
    ...
    try {
      ...
      if (permission == LocationPermission.deniedForever) {
        emit(const LocationPermissionDenied(message: 'Les autorisations de localisation sont définitivement refusées.'));
        return;
      }

      if (permission == LocationPermission.denied) {
        emit(const LocationPermissionDenied(message: 'Autorisation de localisation refusée.'));
        return;
      }
