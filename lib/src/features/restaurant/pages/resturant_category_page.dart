  ...
  void _loadRestaurants() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('${AppLocalizations.of(context)!.loadingError}: $e'),
          ...
          children: [
            ...
            IconButton(
              ...
              onPressed: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(AppLocalizations.of(context)!.addToFavorites),
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 16),
                      Text(
                        AppLocalizations.of(context)!.noRestaurantNear,
                        style: TextStyle(
                          fontSize: 16,
                          color: Colors.grey[600],
                        ),
