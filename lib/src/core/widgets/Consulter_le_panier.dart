          ...
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Text(
                        AppLocalizations.of(context)!.products(_cartService.items.length),
                        style: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w500,
                          color: Colors.grey[800],
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      _buildPriceRow(AppLocalizations.of(context)!.subtotal, '${_subtotal.toStringAsFixed(0)} DA'),
                      const SizedBox(height: 8),
                      _buildPriceRow(AppLocalizations.of(context)!.platformFee, '${platformFee.toStringAsFixed(0)} DA'),
                      if (selectedDeliveryOption == 'delivery') ...[
                        const SizedBox(height: 8),
                        _buildPriceRow(AppLocalizations.of(context)!.deliveryFee, '${_actualDeliveryFee.toStringAsFixed(0)} DA'),
                      ],
                      const SizedBox(height: 12),
                      _buildPriceRow(AppLocalizations.of(context)!.total, '${_total.toStringAsFixed(0)} DA', isTotal: true),
                    ],
                  ),
                ),
                ...
                _buildPaymentOption(AppLocalizations.of(context)!.cash, Icons.money, 'cash_on_delivery'),
                _buildPaymentOption(AppLocalizations.of(context)!.baridiMob, Icons.phone_android, 'baridi_mob'),
                _buildPaymentOption(AppLocalizations.of(context)!.bankTransfer, Icons.account_balance, 'bank_transfer'),
                ...
                _buildDeliveryOption(AppLocalizations.of(context)!.pickup, Icons.store, 'pickup'),
                _buildDeliveryOption(AppLocalizations.of(context)!.delivery, Icons.pedal_bike, 'delivery'),
