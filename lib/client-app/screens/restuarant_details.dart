...
import 'Consulter_le_panier.dart';
...
class _RestaurantDetailsPageState extends State<RestaurantDetailsPage> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final items =
          await _service.getMenuItems(restaurantId: widget.restaurant.id);
      ...
      setState(() {
        ...
        for (var item in items) {
          ...
          if (!displayMap.containsKey(nameKey)) {
            ...
            displayMap[nameKey] =
                MenuItemCategory(id: displayId, nom: displayName);
  ...
  Future<void> _navigateToMenuItemDetail(MenuItem item) async {
    ...
    if (result != null && result is Map<String, dynamic>) {
      final menuItem = result['menuItem'] as MenuItem;
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => ConsulterLePanier(
          ...
          deliveryAddress:
              'Baraki, Sidi Moussa', // TODO: Get from user location service
          restaurantLocation: LatLng(
            widget.restaurant.lat ?? 0.0,
            widget.restaurant.lng ?? 0.0,
          ),
          deliveryLocation:
              const LatLng(36.7538, 3.0588), // TODO: Get from user location
        ),
      ),
    );
  }

  Widget _buildFoodItem(MenuItem item) {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.only(
                          bottom: _cartService.isNotEmpty ? 80 : 20),
                      child: _loading
                          ? Center(
                              child: Padding(
    ...
    final filteredItems = _selectedCategoryId == null
        ...
        : _menuItems.where((item) {
            ...
            if (item.categoryId.isEmpty &&
                selectedId.toLowerCase().trim() == nameKey) return true;
