...
class _ValiderLaCommandePageState extends State<ValiderLaCommandePage> {
  ...
  void _fitMarkersInBounds() {
    ...
    final double minLat = _pickupLatLng.latitude < _deliveryLatLng.latitude 
        ? _pickupLatLng.latitude 
        : _deliveryLatLng.latitude;
    final double maxLat = _pickupLatLng.latitude > _deliveryLatLng.latitude 
        ? _pickupLatLng.latitude 
        : _deliveryLatLng.latitude;
    final double minLng = _pickupLatLng.longitude < _deliveryLatLng.longitude 
        ? _pickupLatLng.longitude 
        : _deliveryLatLng.longitude;
    final double maxLng = _pickupLatLng.longitude > _deliveryLatLng.longitude 
        ? _pickupLatLng.longitude 
        : _deliveryLatLng.longitude;
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildInfoRow(
                        ...
                        title: 'Total',
                        subtitle: '${widget.totalPrice.toStringAsFixed(2)} DA',
                        isTotal: true,
                      ),
                      _buildDivider(),
        ...
        content: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  _buildSummaryRow('Total', '${widget.totalPrice.toStringAsFixed(2)} DA'),
                  const Divider(height: 16),
                  _buildSummaryRow('Paiement', widget.paymentMethod),
                  const Divider(height: 16),
                  _buildSummaryRow('Livraison', widget.estimatedTime),
                ],
              ),
            ),
          ],
