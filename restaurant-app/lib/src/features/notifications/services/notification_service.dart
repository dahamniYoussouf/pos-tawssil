...
class NotificationService {
  ...
  static const String _channelId = 'tawsil_restaurant_notifications';
  static const String _channelName = 'Order Notifications';
  static const String _channelDescription =
      'Real-time order and restaurant notifications';
  ...
  Future<void> _registerDeviceToken(String fcmToken) async {
    ...
    final response = await _baseApiService.postRequest(
      ...
      data: <String, dynamic>{
        'token': fcmToken,
        'platform': platform,
        'device_id': '$platform-restaurant-$userId',
      },
    );
  ...
  void _handleConnectionChange({required bool isConnected, String? reason}) {
    ...
    _isConnecting = false;
    dev.log(
        '[NotificationService] State updated: isConnected=$isConnected',
        name: 'NotificationService');
