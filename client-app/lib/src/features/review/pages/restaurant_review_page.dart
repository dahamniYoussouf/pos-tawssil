        ...
        listener: (context, state) {
          if (state is ReviewSuccess) {
            ...
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => OrderReviewPage(orderId: widget.orderId),
              ),
            );
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Restaurant icon
                    Image.asset(
                      MediaRes.reviewRestaurantImage,
                      width: 200,
                      height: 200,
                      fit: BoxFit.contain,
                    ),
                        ...
                        children: [
                          TextButton(
                            onPressed: isLoading
                                ? null
                                : () {
                                    // Skip restaurant review, go to order review
                                    Navigator.pushReplacement(
                                      context,
                                      MaterialPageRoute(
