...
const AdminLayoutContent = ({
  ...
  const menuSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { title: 'Validation client', icon: ClipboardList, href: '/admin/review-queue', path: '/admin/review-queue' }
      ]
    },
    {
  ...
  const getBreadcrumb = (pathname: string) => {
    ...
    const routes: Record<string, string> = {
      ...
      '/admin/review-queue': 'Validation client',
  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-slate-900">
      ...
      <NotificationPopupWrapper 
        onViewDetails={(notificationId, type) => {
