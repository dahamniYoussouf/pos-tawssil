...
interface NotificationPopupProps {
  onViewDetails?: (notificationId: string, type?: NotificationData['type']) => void;
}
...
export default function NotificationPopup({ onViewDetails }: NotificationPopupProps) {
  ...
  const handleViewDetails = (id: string) => {
    ...
    if (onViewDetails) {
      onViewDetails(id, notification?.type);
    } else if (notification?.type === 'order_admin_review_required') {
