...
export const seedHomepageModules = async ({ restaurants, restaurantMenuMap, categoryAssignments = [] }) => {
  ...
  const thematicTemplates = [
    ...
    },
    {
      ...
      description: "Pizzas artisanales avec p�te croustillante",
  ...
  console.log(`Ã��?��™o. ${createdHomeCategories.length} home categories created`);
  console.log(`Ã��?��™o. ${createdThematicSelections.length} thematic selections created`);
  console.log(`Ã��?��™o. ${createdRecommendedDishes.length} recommended dishes created`);
  console.log(`Ã��?��™o. ${createdPromotions.length} promotions created`);
  console.log(`Ã��?��™o. ${createdDailyDeals.length} daily deals created`);
  console.log(`Ã��?��™o. ${createdAnnouncements.length} announcements created`);
