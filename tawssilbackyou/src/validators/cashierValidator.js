...
const normalizePermissions = (value) => {
  ...
  if (Object.prototype.hasOwnProperty.call(value, "can_create_orders")) {
    return { can_create_orders: Boolean(value.can_create_orders) };
  }
  return {};
};
...
export const registerCashierValidator = [
  ...
  body("permissions")
    ...
    .customSanitizer(normalizePermissions)
    .custom((value) => {
