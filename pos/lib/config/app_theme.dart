...
class TawsilColors {
  ...
  static const Color primary = Color(0xFF3D6B57);
  static const Color primaryDark = Color(0xFF2F5747);
  static const Color primaryLight = Color(0xFFE3EFE8);
  
  // Accent Colors
  static const Color accent = Color(0xFFF3C15F);
  static const Color accentLight = Color(0xFFF9DB9A);
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      appBarTheme: const AppBarTheme(
        ...
        foregroundColor: TawsilColors.textPrimary,
        elevation: 0,
        centerTitle: true,
