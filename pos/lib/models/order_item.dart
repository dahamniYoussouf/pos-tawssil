...
class OrderItem {
  ...
  factory OrderItem.fromMap(Map<String, dynamic> map) {
    ...
    return OrderItem(
      ...
      promotionalPrice: (map['promotion_price'] as num?)?.toDouble(),
  ...
  factory OrderItem.fromJson(Map<String, dynamic> json) {
    ...
    return OrderItem(
      ...
      additionsTotal: _toDouble(json['additions_total']),
      additions: additions,
      instructionsSpeciales: json['special_instructions'] ?? json['instructions'],
      createdAt: DateTime.tryParse(json['created_at'] ?? '') ?? DateTime.now(),
      updatedAt: DateTime.tryParse(json['updated_at'] ?? '') ?? DateTime.now(),
      promotionalPrice: _toDouble(json['promotion_price'] ?? json['discounted_price'] ?? json['effective_price']),
    );
  }
